...
module.exports = {
	...
	description: 'Mostrar servico em estoque.', // Command description
	...
	execute(message) {
        ...
        fs.readdir(`${__dirname}/../stock/`, function (err, files) {
            ...
            if (err) return console.log('Impossivel scanear o diretorio: ' + err);
            ...
            .setTitle(`${message.guild.name} tem **${stock.length} servicos**`)
            .setDescription('')
